...
-- Tiempo de generación: 07-09-2024 a las 16:14:24
...
(11, 'Pérez', 'Juan', '1985-06-15 00:00:00', 'EmpID11.jpg', 'Juan tiene una licenciatura en administración de empresas de la Universidad Nacional Autónoma de México. Actualmente está cursando un MBA en línea.'),
(13, 'Smith', 'Emily', '1990-03-22 00:00:00', 'EmpID12.png', 'Emily has a master\'s degree in software engineering from Stanford University. She is passionate about artificial intelligence and participates in several open source projects.');
...
(1, 'Café', 2, 3, '5 cajas x 30 paquetes', 25),
...
(78, 'Café', 2, 3, '5 cajas x 30 paquetes', 25),
(79, 'Café', 2, 3, '5 cajas x 30 paquetes', 25),
(80, 'Café', 2, 3, '5 cajas x 30 paquetes', 25);
...
--
ALTER TABLE `employees`
  MODIFY `EmployeeID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `products`
  MODIFY `ProductID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
